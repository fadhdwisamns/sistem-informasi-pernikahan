    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                {{-- Form action diubah ke route 'laporan.show' --}}
                <form action="{{ route('laporan.show') }}" method="GET" class="mt-6 space-y-6">

                    {{-- BAGIAN BARU: HANYA TAMPIL JIKA USER ADALAH ADMIN --}}
                    ...
                    <div>
                        ...
                        {{-- Untuk menampilkan pesan error jika KUA tidak dipilih --}}
