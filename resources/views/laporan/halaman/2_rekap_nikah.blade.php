...
<html lang="id">
<head>
    <meta charset="UTF-8"><title>Rekapitulasi Daftar Nikah</title>
    <style>
        @page { margin: 0; }
...
<body>
    <div class="page">
        ...
        <div class="content">
            <h4 style="font-weight: bold; text-align: center; font-size: 14pt; margin-top: 1rem; text-decoration: underline;">REKAPITULASI DAFTAR NIKAH</h4>
            ...
            <table class="data-table" style="width: 100%; margin-top: 1rem;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">{{ \Carbon\Carbon::parse($data->tanggal_daftar)->format('d-m-Y') }}</td>
                        <td style="text-align: center;">{{ \Carbon\Carbon::parse($data->tanggal_akad)->format('d-m-Y') }}</td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="5" style="text-align: center; height: 50px;">Tidak ada data untuk periode ini.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
